...
def train(model, model_three, optimizer, loss_fn, trainloader, valloader, device, maxi):
    ...
    for epoch in range(30):
        ...
        for batch_num, (data, target) in enumerate(trainloader):
            ...
            three_target1[(three_target1 == 7).nonzero()] = 10
            three_target1[(three_target1 == 8).nonzero()] = 11
            three_target1[(three_target1 == 9).nonzero()] = 12
        ...
        print("Epoch: ", epoch + 1, "\nTrain: ", model_three.acc / num_three)
         ...
         #   print("checkpoint saved")
          ...
          #  torch.save(model_three.state_dict(), "CWRU_3.pth")
...
if __name__ == "__main__":
    ...
    model_three.load_state_dict(torch.load('./CWRU_3.pth'))
